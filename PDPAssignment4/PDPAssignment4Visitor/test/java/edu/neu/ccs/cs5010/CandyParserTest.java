...
public class CandyParserTest {
    ...
    public void testParseCandy() throws Exception {
        ...
        Assert.assertTrue("Should return true because arraylist should " +
            "include 'twix', 'super size' ", candyParser.parseCandy(superSizeTwix)
            .get(0).toLowerCase().equals(candyNameAndSize.get(0))
            && candyParser.parseCandy(superSizeTwix).get(1).toLowerCase()
            .equals(candyNameAndSize.get(1)));
        ...
        Assert.assertTrue("Should return true because arraylist should include " +
            "'snickers', 'regular size' ", candyParser.parseCandy(regularSizeSnickers)
            .get(0).toLowerCase().equals(candyNameAndSize.get(0))
            && candyParser.parseCandy(regularSizeSnickers).get(1).toLowerCase()
            .equals(candyNameAndSize.get(1)));
        ...
        Assert.assertTrue("Should return true because arraylist should include " +
            "'kit kat', 'regular size' ",candyParser.parseCandy(regularSizeKitKat)
            .get(0).toLowerCase().equals(candyNameAndSize.get(0))
            && candyParser.parseCandy(regularSizeKitKat).get(1).toLowerCase()
            .equals(candyNameAndSize.get(1)));
        ...
        Assert.assertTrue("Should return true because arraylist should include " +
            "'kit kat', 'fun size' ",candyParser.parseCandy(funSizeKitKat)
            .get(0).toLowerCase().equals(candyNameAndSize.get(0)) && candyParser
            .parseCandy(funSizeKitKat).get(1).toLowerCase().equals(candyNameAndSize.get(1)));
        ...
        Assert.assertTrue("Should return true because arraylist should include " +
            "'almond joy', 'king size' ", candyParser.parseCandy(kingSizeAlmondJoy)
            .get(0).toLowerCase().equals(candyNameAndSize.get(0))
            && candyParser.parseCandy(kingSizeAlmondJoy).get(1).toLowerCase()
            .equals(candyNameAndSize.get(1)));
        ...
        Assert.assertTrue("Should return true because arraylist should include " +
            "'mars', 'king size' ",candyParser.parseCandy(" King Size Mars")
            .get(0).toLowerCase().equals(candyNameAndSize.get(0))
            && candyParser.parseCandy(" King Size Mars").get(1).toLowerCase()
            .equals(candyNameAndSize.get(1)));
